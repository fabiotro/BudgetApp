...
This project is indexed by GitNexus as **BudgetApp** (681 symbols, 1294 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
