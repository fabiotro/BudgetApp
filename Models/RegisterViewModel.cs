...
namespace BudgetApp.Models
{
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAnnotations))]
        [StringLength(100, MinimumLength = 8, ErrorMessageResourceName = "StringLengthMin", ErrorMessageResourceType = typeof(DataAnnotations))]
        ...
        [Required(ErrorMessageResourceName = "Required", ErrorMessageResourceType = typeof(DataAnnotations))]
        [DataType(DataType.Password)]
        [Compare(nameof(Password), ErrorMessageResourceName = "PasswordMismatch", ErrorMessageResourceType = typeof(DataAnnotations))]
